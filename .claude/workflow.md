...
| **Next gate** | P07 step 1 — verify spec. Long-form contract at `docs/superpowers/specs/2026-04-27-roadmap.md` § Phase 7. Self-update + INI refresh + bundled markdown help searchable via Cmd-K. New `updates/` + `help/` modules + the shared `downloads.py` primitive that P08 reuses. User said 2026-05-04 "I want us to get this project to a point where I can start using it" — P07/P08/P09 are the remaining v1.0.0 path. |
