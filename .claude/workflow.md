...
| **Active item ID** | **none pinned** — user to pick the next media/ item. Queue: 1081 (`media.snaps_dir` binding — small), 1084 (Settings enable/disable), 1079 (MobyGames cover-fetch — **blocked on a real MobyGames API key fixture**). (**1082 CLOSED 2026-07-03** — httpx2 dev dep.) |
