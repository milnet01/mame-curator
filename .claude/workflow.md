...
| Field | Value |
|-------|-------|
| **Project phase** | P10 active 2026-05-17 — Media coverage expansion (Step 3: chunks 3a + 3b + 4 + 5 shipped 2026-05-18 — progettoSnaps pair + ArcadeDB + Wikipedia-image bundle). FP31 test-audit fold-in shipped 2026-05-18 (second sweep, 6 HIGH + 21 MEDIUM inline; 11 LOW/INFO clusters deferred as mame-curator-1046..1056). FP29 closed 2026-05-17 (RetroArch executable + core PathRows on Settings → Paths; ships the UI half of FP22-C). P14 closed 2026-05-17 — per-game review state. Docs bundle (mame-curator-1029 + 1030) closed 2026-05-16. DS03 closed 2026-05-16. DS05 closed 2026-05-16. DS02 closed 2026-05-15 + R2 hot-fix. FP28 closed 2026-05-15. DS04 closed 2026-05-15. FP27 closed 2026-05-14. Queue continues **post-v1**. |
...
| **Blocked on** | nothing. |
| **Last update** | 2026-05-18 (**FP31 test-audit fold-in** — second `/test-audit` sweep ran across all 18 dimensions / all severities / 163 files (113 backend + 50 frontend) → 106 raw findings → 24 fixed inline (6 HIGH + 18 MEDIUM) + 1 reverted MEDIUM (FsBrowser prefetch — SUT design Q deferred to mame-curator-1047) + 11 deferred clusters as mame-curator-1046..1056. Allowlist entry 014 added for `test_runner_lifecycle.py:51` negative-wait pattern (same shape as 008). Test-count pin 614 → 611 backend (-3: removed 4 duplicates, added 1 year=None coverage test) + 304 → 305 frontend (+1: useValidateCart 500-error coverage). Five gates green: 758 backend / 0 ruff / 0 mypy / 0 bandit / api-types-sync; 320 frontend vitest / 0 eslint. Pre-existing `tsc` errors in `src/test/handlers.ts` + `renderWithClient.tsx` left untouched.) |
